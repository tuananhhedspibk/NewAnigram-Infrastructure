...
export LOG_GROUP=/aws/ecs/newanigram/migration

ecspresso run --config $ECSPRESSO_CONFIG --overrides '{"containerOverrides":[{"name":"api", "command":["yarn", "rdb:migration:run"] }]}'
